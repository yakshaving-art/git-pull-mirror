...
.PHONY: build
build:
	@go build -ldflags "-X gitlab.com/yakshaving.art/git-pull-mirror/version.Version=$(VERSION) -X gitlab.com/yakshaving.art/git-pull-mirror/version.Commit=$(COMMIT_ID) -X gitlab.com/yakshaving.art/git-pull-mirror/version.Date=$(COMMIT_DATE)"
